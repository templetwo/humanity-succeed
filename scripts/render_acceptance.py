...
ROWS = [
    ...
    ("WP1.2", "Derivation-graph split audit; descendants share one split", "implemented",
     [f"{UT}/test_splits_and_compiler.py"], "unit", "near-duplicate check is normalized-text only"),
    ...
    ("WP1.4", "Deterministic manifests; four separate views", "implemented",
     ...
     "unit", ""),
    ("WP1.5", "Leakage lints (4-gram overlap, hidden labels)", "implemented",
     [f"{UT}/test_splits_and_compiler.py::test_lint_flags_hidden_labels_and_overlap"], "unit",
     "phrase lint is not semantic proof; disposition workflow not built"),
